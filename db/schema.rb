...
ActiveRecord::Schema.define(version: 2019_02_11_141324) do

  create_table "languages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.date "first_experience"
    t.integer "skill_id"
    t.string "color"
  ...
  create_table "product_languages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
